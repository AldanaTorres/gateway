...
export class LibroComponent implements OnInit, OnDestroy {
  ...
  loadPage(page?: number, dontNavigate?: boolean): void {
    ...
    this.libroService
      ...
      .subscribe(
        (res: HttpResponse<ILibro[]>) => this.onSuccess(res.body, res.headers, pageToLoad, !dontNavigate),
        () => this.onError()
      );
  }
  ...
  registerChangeInLibros(): void {
    this.eventSubscriber = this.eventManager.subscribe('libroListModification', () => this.loadPage());
  }
