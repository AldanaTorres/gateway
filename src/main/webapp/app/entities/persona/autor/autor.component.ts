...
export class AutorComponent implements OnInit, OnDestroy {
  ...
  loadPage(page?: number, dontNavigate?: boolean): void {
    ...
    this.autorService
      ...
      .subscribe(
        (res: HttpResponse<IAutor[]>) => this.onSuccess(res.body, res.headers, pageToLoad, !dontNavigate),
        () => this.onError()
      );
  }
  ...
  protected onSuccess(data: IAutor[] | null, headers: HttpHeaders, page: number, navigate: boolean): void {
