...
export class LocalidadComponent implements OnInit, OnDestroy {
  ...
  loadPage(page?: number, dontNavigate?: boolean): void {
    ...
    this.localidadService
      ...
      .subscribe(
        (res: HttpResponse<ILocalidad[]>) => this.onSuccess(res.body, res.headers, pageToLoad, !dontNavigate),
        () => this.onError()
      );
  }
  ...
  registerChangeInLocalidads(): void {
    this.eventSubscriber = this.eventManager.subscribe('localidadListModification', () => this.loadPage());
  }
